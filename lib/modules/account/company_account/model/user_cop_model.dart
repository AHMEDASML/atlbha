...
//
//     final userCompModel = userCompModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

UserCompModel userCompModelFromJson(String str) => UserCompModel.fromJson(json.decode(str));

String userCompModelToJson(UserCompModel data) => json.encode(data.toJson());
...
class UserCompModel {
  ...
  factory UserCompModel.fromJson(Map<String, dynamic> json) => UserCompModel(

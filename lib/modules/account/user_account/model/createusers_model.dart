...
CreateUsersModel createUsersModelFromJson(String str) => CreateUsersModel.fromJson(json.decode(str));

String createUsersModelToJson(CreateUsersModel data) => json.encode(data.toJson());
